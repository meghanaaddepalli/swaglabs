...
public class CancelPageStep {
	CancelPage lp = new CancelPage();
...
//	}
	...
	@Then("^user enter the usrname,$")
	public void the_user_login_using_usrname() throws InterruptedException, IOException {
	...
	@Then("^click login button user will navigate the next page,$")
	public void click_on_login_button_user_nagivate_to_the_next_page() throws InterruptedException {
		// Write code here that turns the phrase above into concrete actions
		lp.LoginBtn();
	...
	@And("^user clicks the card button,$")
