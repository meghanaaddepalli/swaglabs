...
public class DropDownPagStep {
	...
	@Given("^user is launched web applications$")
	public void the_user_launch_the_chrome_application() throws IOException {

		lp.browser();
	}

	@When("^user opens the Swaglab Home page$")
	public void the_user_opens_the_Myntra_Home_page() {
	...
	@Then("^click the login btn user will navigate to the next page$")
	public void click_on_the_login_btn_user_nagivate_to_the_next_page() throws InterruptedException {
		// Write code here that turns the phrase above into concrete actions
		lp.LoginBtn();
